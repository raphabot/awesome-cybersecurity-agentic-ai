...
- [IronClaw](https://github.com/IronSecCo/ironclaw) - Security-hardened runtime that sandboxes AI agent tool-calls in gVisor, with a human approval gateway, encrypted task queues, and signed, attested builds (cosign, SBOM, SLSA). AGPL-3.0.
